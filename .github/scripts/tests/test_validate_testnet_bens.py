...
class ValidateTestnetBensTests(unittest.TestCase):
    ...
    def test_deployer_invokes_graph_cli_without_executable_shims(self):
        ...
        self.assertIn("body.data._meta.deployment !== expectedDeployment", compose)
        self.assertIn("body.data._meta.hasIndexingErrors !== false", compose)
        self.assertIn("body.errors", compose)
