...
| Backend | `ghcr.io/dos/doscan:11.2.4.commit.2d53484e@sha256:370eb1e8360ca86dfca3e13f9ffd0cb34e3d90be51cfbaf3abc91416994dc32e` |
| Interchain Indexer | `v1.6.0`, Mainnet only |

The `2d53484e` build retains the behavior introduced by DOS patch `86fd0dd5`, which omits an original thumbnail when none exists for an NFT video record. The build also includes the direct `xav` dependency required for video decoding.
...
| Backend version endpoint | `v11.2.4.+commit.2d53484e` | `v11.2.4.+commit.2d53484e` |
...
The current production head also passed [Deploy Config run 30926419497](https://github.com/DOS/DOScan/actions/runs/30926419497) for both environments.
